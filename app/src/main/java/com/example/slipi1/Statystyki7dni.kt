...
class Statystyki7dni : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_statystyki_7dni)
        ...
        firestore.collection("WpisySnu")
            ...
            .addOnSuccessListener { result ->
                ...
                if (wpisy.isNotEmpty()) {
                    ...
                    alkoholText.text = "W ciągu ostatnich 7 dni piłeś/aś alkohol $alkohol razy."
                    ...
                    if (alkohol > 3) ogranicz.add("alkohol")
                    if (kofeina > 3) ogranicz.add("kofeinę po 18:00")
                    if (telefon > 3) ogranicz.add("korzystanie z telefonu przed snem")
                    if (posilek > 3) ogranicz.add("późne posiłki")

                    if (aktywnosc < 3) zadbaj.add("regularną aktywność fizyczną")
                    if (wyciszenie < 3) zadbaj.add("częstsze wyciszenie przed snem")

                    val wstep = "Na podstawie Twoich ostatnich 7 dni snu zauważyliśmy pewne nawyki, które mogą wpływać na jego jakość.\n"
                    ...
                    val finalnaWiadomosc = if (ograniczTekst.isEmpty() && zadbajTekst.isEmpty()) {
                        "Na podstawie Twoich ostatnich 7 dni snu nie zauważyliśmy żadnych nawyków, które mogłyby negatywnie wpływać na jego jakość.\nŚwietna robota! Kontynuuj dobre praktyki – są świetną podstawą do zdrowego i regenerującego snu 😊"
                    } else {
                    ...
                    jakoscText.text = "-"
                    pobudkiText.text = "-"
                    wnioskiText.text = "Brak danych z ostatnich 7 dni."
                }
            }
    }
